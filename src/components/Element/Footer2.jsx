...
const Footer2 = () => {
  return (
    <div className="bg-blue-900  p-10 rounded w-full lg:grid md:grid md:grid-cols-4 lg:grid-cols-4 lg:place-items-center gap-28 text-center sm:text-start min-h-[200px] shadow-md shadow-slate-900 mt-9">
