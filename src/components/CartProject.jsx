    ...
    <div className="flex justify-center">
      <div className="w-[300px]  sm:w-[600px] bg-gradient-to-r from-slate-50 to-blue-400 p-10 rounded-xl gap-5 ">
        ...
        <div className="mt-5 flex gap-5 justify-between">
          <button className="bg-blue-500 p-2 text-sm text-white rounded-xl cursor-pointer hover:bg-slate-500 font-bold whitespace-nowrap duration-100">
            <a href={url} target="_blank" rel="noreferrer">
              Visit Link
            </a>
          </button>
          <button className="bg-blue-500 p-2 text-sm text-white rounded-xl cursor-pointer hover:bg-slate-500 font-bold whitespace-nowrap flex justify-between gap-2 items-center ">
            <span>
